...
export class Avatar {
  ...
  animateBody(delta){return updateBody(this,delta);}

  seedFeet(){
    if(!this.bones)return;
    this.actor.rotation.y=this.yaw+this.turnOffset;
    this.footwork=new Footwork(THREE,this.actor,this.bones,this.hipPosition,this.modelHeight);
  ...
  advanceMotion(delta){
    ...
    const cruise=(this.carrying?.39:.46)*scale;
